...
export default async function Home() {
    ...
    return (
        <div className="">
            ...
            {/*</Marquee>*/}
            <div className="">
                <div className="bg-gradient-to-b from-purple-200 pt-16 to-white">
                ...
                <div className="max-w-3xl mx-auto px-5 md:px-0 rounded-lg border border-gray-300 overflow-hidden">
                    {
