...
export default function Onboarding() {
    ...
    const calculateProgress = () => {
        ...
        if (name && name !== "Your startup name") filledFields++;
        if (estDate) filledFields++;
        if (founders && founders !== "Your Name(s) here") filledFields++;
        if (oneLiner && oneLiner !== "A brief description of your startup") filledFields++;
        if (description && description !== "A less-brief description of your startup. Lorum Ipsum") filledFields++;
        if (industry) filledFields++;
        if (uploadedLogo) filledFields++;
        ...
        <div className="">
            ...
            <div className="max-w-3xl mx-auto mt-24 px-5 md:px-0">
                ...
                <h1 className="text-4xl text-black/90 font-bold mb-12">Join the <span
                    className="text-purple-600">###</span> active
